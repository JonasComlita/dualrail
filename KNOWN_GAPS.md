...
- Add VFS allocator reclamation/compaction and rename. Extent reservation,
  writes, inode-specific `fsync`, torn-record recovery, namespace/quota policy
  home pages, and the existing crash matrix are covered.
