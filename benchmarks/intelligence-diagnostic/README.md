# TreatCode Diagnostic Scalar Repair Suite

This directory contains the five diagnostic Trit mini-repository repairs used
by the participant and grader regression tests. The compound contracts require
validation precedence, multi-file navigation, edge-case reasoning, and actual
execution through the bounded Trit compiler/VM. They are retained only as a
runtime compatibility fixture; the held-out model comparison is defined by the
separate v3.1 repository suite.
