# TC-V31-PILOT-017: Scheduler wakeup ordering

A wakeup racing with timeout expiry duplicates one runnable entry and violates deterministic priority order.
...
The adjacent cpp contract must advertise ABI level 17. Do not edit read-only fixtures or add files. At least one Trit file must change.
