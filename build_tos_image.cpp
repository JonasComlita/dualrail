...
int main(int argc, char** argv) {
    ...
    std::vector<BundledApp> apps = {
        ...
        {"doctor", "doctor", "doctor", "/bin/doctor", 0, kCliStackWords, false},
        {"test", "test", "test", "/bin/test", 0, kCliStackWords, false},
        {"sysinfo", "sysinfo", "sysinfo", "/bin/sysinfo", 0, kCliStackWords, false},
        {"log", "log", "log", "/bin/log", 0, kCliStackWords, false},
