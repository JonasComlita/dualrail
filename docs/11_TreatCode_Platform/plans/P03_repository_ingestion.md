...
- [ ] Every Git-tracked file is indexed or excluded by a documented rule.
- [ ] Every source reference contains repository, commit, path, and source span
      when the parser supports spans.
- [ ] Supported-language symbol references resolve back to exact source.
- [ ] Manifest, test, benchmark, documentation, and decision edges are queryable.
- [ ] A clean index and an incremental index of the same commit are equivalent.
- [ ] Generated and downloaded artifacts are labeled and never promoted to
      source authority.
- [ ] Context packages contain only requested scope, direct dependencies,
...
- **Verified commit:**
- **Evidence artifact:**
- **Human approvals:** Code-intelligence maintainer
- **Date:**
