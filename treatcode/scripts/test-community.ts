// P14 plan-facing entry point. Keep the focused account/community checks in
...
const evidenceRoot = path.resolve(import.meta.dir, "..", "..", "build", "treatcode-plan-evidence", "P14");
