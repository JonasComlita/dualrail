---
{
  ...
  "id": "tcl-language-contract",
  "title": "The TCL language contract",
  "module": "Phase 08 · TCL language contract",
  "level": "beginner",
  "order": 16,
  "summary": "Build the mental model for TCL language contract.",
  ...
  "interactive": {
    "kind": "choice",
    "title": "Concept check",
    "prompt": "Which statement keeps the tcl-language boundary honest?",
    "options": [
    ...
    "answer": 1,
    "explanation": "The repository boundary is defined by the current source and validation evidence for TCL language contract. Planned and unavailable work remains labelled."
  }
}
---
...
[Continue to the next lesson](/learn/eecs/first-tcl-program). The next page should make the dependency explicit and keep the same distinction between general concept, current Trit behavior, and planned work. When you reach the terminal lesson, write the closure report and list residual gaps instead of assuming that navigation itself proves completion.
