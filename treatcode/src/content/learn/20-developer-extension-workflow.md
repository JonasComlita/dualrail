---
{
  ...
  "id": "developer-extension-workflow",
  "title": "Investigate an extension boundary",
  "module": "Phase 19 · Specialized libraries and developer products",
  "level": "eecs",
  "order": 39,
  "summary": "Trace the repository evidence for Specialized libraries and developer products.",
  ...
  "prerequisites": [
    "specialized-libraries-products"
  ],
  "sources": [
    {
  ...
  "next": "security-fuzzing-performance-closure",
  "interactive": {
    "kind": "code",
    ...
    "exercise_id": "developer-extension-workflow",
    "runner": "treatcode-learning-compiler",
    "explanation": "Submit the bounded TCL example to the repository-backed learning runner. It may pass or report a real compiler failure; either result is evidence about the Specialized libraries and developer products exercise, not a local text-only success."
  }
}
---
...
Read [specialized-libraries-products](/learn/eecs/specialized-libraries-products) first. Those lessons introduce the state and vocabulary that this page assumes. This is the build, trace, and evidence lesson for Specialized libraries and developer products. The goal is to inspect a real repository transition and report both what the current tests prove and what they do not prove. A prerequisite is a reasoning dependency, not a UI gate: a direct link to this page must still explain what is assumed.
...
[Continue to the next lesson](/learn/eecs/security-fuzzing-performance-closure). The next page should make the dependency explicit and keep the same distinction between general concept, current Trit behavior, and planned work. When you reach the terminal lesson, write the closure report and list residual gaps instead of assuming that navigation itself proves completion.
